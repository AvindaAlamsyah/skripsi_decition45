        ...
        <aside class="left-sidebar">
            ...
            <div class="scroll-sidebar">
                ...
                <nav class="sidebar-nav">
                    <ul id="sidebarnav">
                        <li> <a class="waves-effect waves-dark" href="" aria-expanded="false"><i class="ti-layout-media-right-alt"></i><span class="hide-menu">Forms</span></a>
                        ...
                        <li> <a class="waves-effect waves-dark" href="" aria-expanded="false"><i class="ti-layout-media-right-alt"></i>Forms</a>
                        </li>
                    </ul>
                </nav>
